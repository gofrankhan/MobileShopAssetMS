...
<div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="index.php" class="logo-text"><span>AMS</span></a>
                    </div><!-- Logo Box -->
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><?php echo $name1;?><i class="fa fa-angle-down"></i></span>
                                        <img class="img-circle avatar" src="assets/images/avatar1.png" width="40" height="40" alt="">
                                    </a>
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="profile.php"><i class="fa fa-user"></i>Profile</a></li>
                                        <li role="presentation"><a href="calendar.php"><i class="fa fa-calendar"></i>Calendar</a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a href="lock-screen.php"><i class="fa fa-lock"></i>Lock screen</a></li>
                                        <li role="presentation"><a href="change-password.php"><i class="fa fa-eye-slash"></i>Change PWD</a></li>
                                ...
                                <!-- Section were chat window as li -->
